  ...
  return (
   <div className="modal">
     ...
     <ul className="awards">
       ...
       <li className="award">
         <h4 className="awardTitle">National AP Scholar Award</h4>
         <h5>College Board</h5>
         <h6 className="awardDate">Jul 2020</h6>
         <h6>Awarded the highest AP honor possible for achieving an AP Score of at least 4 or above (on a scale of 5) in all AP Exams taken and score of 4 or higher on at least 8 AP Exams</h6>
       </li>
       <li className="award">
